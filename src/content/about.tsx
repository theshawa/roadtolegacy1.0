const startQuote = (
  <span className="inline-block">
    <svg fill="#F36430" height="40px" width="25px" viewBox="0 0 32 32">
      <g>
        <path
...
const endQuote = (
  <span className="inline-block">
    <svg fill="#F36430" height="25px" width="25px" viewBox="0 0 32 32">
      <g>
        <path
          d="M23,9c-2.8,0-5,2.2-5,5s2.2,5,5,5c0.3,0,0.7,0,1-0.1c-1.3,1.3-3,2.1-5,2.1c-0.6,0-1,0.4-1,1s0.4,1,1,1c5,0,9-4,9-9
C28,11.2,25.8,9,23,9z"
        />
        <path
          d="M9,9c-2.8,0-5,2.2-5,5s2.2,5,5,5c0.3,0,0.7,0,1-0.1C8.7,20.2,7,21,5,21c-0.6,0-1,0.4-1,1s0.4,1,1,1c5,0,9-4,9-9
...
export const ABOUT = {
  ...
  content: (
    <>
      ...
      industry. Most of them certainly don’t have an idea about where they want
      to go. Most just flows with the degree program.
      <br />
      <br />
      ...
      world cases, what arethe skills needed to excel in that and how to develop
      them in the next 3 / 4 years..
    </>
  ),
};
